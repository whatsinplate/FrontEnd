            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      _buildTextField('Новый пароль', 'Введите новый пароль'),
                      const SizedBox(height: 20),
                      _buildTextField('Подтвердите пароль', 'Введите новый пароль'),
                      const SizedBox(height: 30),
                      ElevatedButton(
                        onPressed: () {
                          // Возвращаемся на экран входа и удаляем историю навигации
  ...
  Widget _buildTextField(String label, String hint) {
    return Column(
      ...
      children: [
        ...
        TextField(
          obscureText: true, // Скрываем пароль точками
